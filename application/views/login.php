...
<html lang="en" class="light">
    ...
    <head>
        <meta charset="utf-8">
        <link href="<?= base_url('assets/template/Compiled/') ?>dist/images/logo.svg" rel="shortcut icon">
            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    <a href="" class="-intro-x flex items-center pt-5">
                        <img alt="Midone - HTML Admin Template" class="w-6" src="<?= base_url('assets/template/Compiled/') ?>dist/images/logo.svg">
                        <span class="text-white text-lg ml-3"> Tinker </span> 
                    </a>
                    <div class="my-auto">
                        <img alt="Midone - HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="<?= base_url('assets/template/Compiled/') ?>dist/images/illustration.svg">
